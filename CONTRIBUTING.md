# Contributing to `attackmap-analyzer-php-laminas`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-php-laminas.git
cd attackmap-analyzer-php-laminas
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-php-laminas/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-php-laminas/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-php-laminas`, you agree that your contributions will be
